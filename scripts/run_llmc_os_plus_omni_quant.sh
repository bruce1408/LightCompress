...
task_name=Llama_3_8B_ominiq_w_a
config=${llmc}/configs/quantization/methods/OmniQuant/omniq_w_a.yml

LOG_DIR="/mnt/share_disk/LLM_workspace/Quantizer-Tools/_output/llm_log/Llama_3_8B_ominiq_w_a"
mkdir -p ${LOG_DIR}
